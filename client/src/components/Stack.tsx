  ...
  const stacks = [
    {
      category: 'Testing & QA',
      icon: Code2,
      technologies: ['Playwright', 'E2E Testing', 'Cypress', 'BDD/Gherkin', 'API Testing', 'Jest'],
    },
    {
      category: 'DevOps & Cloud',
      icon: Cloud,
      technologies: ['GitHub Actions', 'Cloudflare', 'CI/CD', 'Docker', 'Kubernetes', 'AWS'],
    },
    {
      category: 'Linguagens & Backend',
      icon: Database,
      technologies: ['TypeScript', 'Node.js', 'Python', 'SQL Server', 'MySQL', 'PostgreSQL'],
    },
    {
      category: 'Tools & Methodologies',
      icon: Zap,
      technologies: ['pnpm', 'Git', 'Agile/Scrum', 'Postman', 'Linux', 'Jira'],
    },
  ];
    ...
    <section id="stack" className="py-20 md:py-32 relative bg-gradient-to-b from-transparent via-card/30 to-transparent">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl items-start">
          {/* Image Column */}
          <div className="md:col-span-1 rounded-xl overflow-hidden border border-border/50 shadow-2xl h-fit sticky top-24 hidden md:block">
            <img
